...
function (_React$Component) {
  ...
  _createClass(Scrollable, [{
    ...
    value: function render() {
      ...
      var finalClassName = classNames(className, styles$6.Scrollable, vertical && styles$6.vertical, horizontal && styles$6.horizontal, topShadow && styles$6.hasTopShadow, bottomShadow && styles$6.hasBottomShadow, vertical && canScroll && styles$6.verticalHasScrolling);
...
function buildColors(colors, roleVariants, colorScheme) {
  return Object.assign.apply(Object, [{}].concat(_toConsumableArray(Object.entries(colors).map(function (_ref) {
    ...
    return Object.assign({}, variants.reduce(function (accumulator, _a) {
      ...
      var resolve = function resolve(value, base) {
        return typeof value === 'number' ? value : value(base);
      };

      return Object.assign(Object.assign({}, accumulator), {
        [name]: hslToString(Object.assign(Object.assign({}, colorToHsla(hsluv.hsluvToHex([resolve(hue, base.hue), resolve(saturation, base.saturation), resolve(lightness, base.lightness)]))), {
          alpha
        }))
      });
    }, {}));
...
function KeypressListener(_ref) {
  var keyCode = _ref.keyCode,
      ...
      keyEvent = _ref$keyEvent === void 0 ? KeyEvent.KeyUp : _ref$keyEvent;
  ...
  function ActionMenu() {
    ...
    _this.renderActions = function () {
      ...
      var actionsMarkup = actions.length > 0 ? actions.map(function (_a, index) {
        var content = _a.content,
            action = tslib.__rest(_a, ["content"]);
...
var Checkbox$1 = React__default.forwardRef(function Checkbox(_ref, ref) {
  ...
  var _useToggle = useToggle(false),
      ...
      forceTrueMouseOver = _useToggle.setTrue,
      forceFalseMouseOver = _useToggle.setFalse;
...
function RadioButton(_ref) {
  ...
  var ariaDescribedBy = describedBy.length ? describedBy.join(' ') : undefined;
  var inputClassName = classNames(styles$E.Input);
  var backdropClassName = classNames(styles$E.Backdrop);
...
function TrapFocus(_ref) {
  ...
  var handleTrappingChange = function handleTrappingChange() {
    if (focusTrapWrapper.current && focusTrapWrapper.current.contains(document.activeElement)) {
      return false;
    }
  ...
  useComponentDidMount(function () {
    return setFocusSelf(handleTrappingChange());
  });
...
function Dialog(_a) {
  ...
  useComponentDidMount(function () {
    containerNode.current && focus.focusFirstFocusableNode(containerNode.current);
  });
...
var styles$1A = /*#__PURE__*/Object.freeze({
  __proto__: null,
  'default': SearchDismissOverlay
});

function SearchDismissOverlay$1(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, visible ? React__default.createElement(ScrollLock, null) : null, React__default.createElement("div", {
    ref: node,
    className: classNames(undefined, visible && undefined),
...
function Search(_ref) {
  ...
  var overlayMarkup = visible ? React__default.createElement(SearchDismissOverlay$1, {
    onDismiss: onDismiss,
...
function SearchField(_ref) {
  ...
  var className = classNames(styles$1C.SearchField, (focused || active) && styles$1C.focused);
  return React__default.createElement("div", {
    className: className,
    onFocus: handleFocus,
    onBlur: handleBlur
...
var TopBar = function TopBar(_ref) {
  ...
  var className = classNames(styles$1H.NavigationIcon, focused && styles$1H.focused);
...
exports.UNSTABLE_DefaultThemeColors = DefaultThemeColors;
