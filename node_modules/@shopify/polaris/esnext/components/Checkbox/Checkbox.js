...
export const Checkbox = React.forwardRef(function Checkbox({ ariaDescribedBy: ariaDescribedByProp, label, labelHidden, checked = false, helpText, disabled, id: idProp, name, value, error, onChange, onFocus, onBlur, }, ref) {
    ...
    const { value: mouseOver, setTrue: forceTrueMouseOver, setFalse: forceFalseMouseOver, } = useToggle(false);
    ...
    <Choice id={id} label={label} labelHidden={labelHidden} helpText={helpText} error={error} disabled={disabled} onClick={handleInput} onMouseOver={forceTrueMouseOver} onMouseOut={forceFalseMouseOver}>
